# Generated by Django 4.2.7 on 2024-02-08 20:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Bestellt', 'Bestellt'), ('Geliefert', 'Geliefert'), ('Abgesagt', 'Abgesagt')], default='Bestellt', max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='PreisListe',
